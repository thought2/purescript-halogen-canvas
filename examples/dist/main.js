...
(function($PS) {
  ...
  exports["succPxiD0xiD1"] = succPxiD0xiD1;
  exports["succPxiD1xiD2"] = succPxiD1xiD2;
  ...
  exports["isZeroD1"] = isZeroD1;
  exports["isZeroD2"] = isZeroD2;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
...
(function($PS) {
  ...
  var cons = function (dictSucc) {
      return function (x) {
          return function (v) {
              return Vec(Data_Array.cons(x)(v));
          };
      };
  };
  var vec2 = function (x) {
      return function (y) {
          return cons(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD2)(Data_Typelevel_Num_Ops.isZeroD2)(Data_Typelevel_Num_Ops.divMod10D1D0)(Data_Typelevel_Num_Ops.succPxiD1xiD2)(Data_Typelevel_Num_Ops.divMod10D2D0))(x)(cons(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)(Data_Typelevel_Num_Ops.isZeroD1)(Data_Typelevel_Num_Ops.divMod10D0D0)(Data_Typelevel_Num_Ops.succPxiD0xiD1)(Data_Typelevel_Num_Ops.divMod10D1D0))(y)(empty));
      };
  };
  exports["empty"] = empty;
  exports["cons"] = cons;
...
(function($PS) {
  "use strict";
  $PS["Halogen.Canvas"] = $PS["Halogen.Canvas"] || {};
  var exports = $PS["Halogen.Canvas"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.canvas(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.ref(refLabel), Halogen_HTML_Properties.width(Data_Vec.index(Data_Typelevel_Num_Sets.natD0)(Data_Typelevel_Num_Ops.trichLt(Data_Typelevel_Num_Ops.trichD0D2))(v.input.size)(Data_Typelevel_Num_Reps.d0)), Halogen_HTML_Properties.height(Data_Vec.index(Data_Typelevel_Num_Sets.natD1)(Data_Typelevel_Num_Ops.trichLt(Data_Typelevel_Num_Ops.trichD1D2))(v.input.size)(Data_Typelevel_Num_Reps.d1)) ])(Data_Maybe.maybe(Data_Monoid.mempty(Data_Monoid.monoidArray))((function () {
          var $35 = Control_Applicative.pure(Control_Applicative.applicativeArray);
          return function ($36) {
              return $35(Halogen_HTML_CSS.style($36));
          };
      })())(v.input.css)));
  };
  ...
  // COMPONENT ACTION
  var getCanvasElement = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(refLabel))(function (v) {
      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Control_Bind.bind(Data_Maybe.bindMaybe)(v)(Web_HTML_HTMLCanvasElement.fromHTMLElement));
  });
  var draw = function (dict) {
      return dict.draw;
  };
  var handleAction = function (dictMonadEffect) {
      return function (dictDraw) {
          return function (v) {
              if (v instanceof Init) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getCanvasElement)(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadEffect)(dictDraw)(new HandleInput(v2.input)))(function () {
              ...
              if (v instanceof HandleInput) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          if (v1.ref instanceof Data_Maybe.Just) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(draw(dictDraw)(v1.ref.value0)(v1.input.picture));
                          };
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  });
              };
              throw new Error("Failed pattern match at Halogen.Canvas (line 96, column 16 - line 108, column 21): " + [ v.constructor.name ]);
          };
      };
  };
  var component = function (dictDraw) {
      return function (dictMonadEffect) {
          return Halogen_Component.mkComponent({
              initialState: initialState,
              render: render,
              "eval": Halogen_Component.mkEval({
                  handleAction: handleAction(dictMonadEffect)(dictDraw),
...
})(PS["Halogen.Canvas.Example.Main"] = PS["Halogen.Canvas.Example.Main"] || {});
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
...
(function($PS) {
  "use strict";
  $PS["Halogen.Canvas.Example.Main"] = $PS["Halogen.Canvas.Example.Main"] || {};
  var exports = $PS["Halogen.Canvas.Example.Main"];
  var $foreign = $PS["Halogen.Canvas.Example.Main"];
  ...
  var Halogen_Canvas = $PS["Halogen.Canvas"];
  var Halogen_VDom_Driver = $PS["Halogen.VDom.Driver"];                
  var Picture = (function () {
      function Picture() {

      };
      Picture.value = new Picture();
      return Picture;
  })();
  var drawPicture = new Halogen_Canvas.Draw($foreign.draw);
  var main = (function () {
      var input = {
          picture: Picture.value,
          css: new Data_Maybe.Just(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(1.0))(Color_Scheme_X11.red)),
          size: Data_Vec.vec2(300)(300)
      };
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Halogen_VDom_Driver.runUI(Halogen_Canvas.component(drawPicture)(Effect_Aff.monadEffectAff))(input)(v);
      }));
  })();
  exports["main"] = main;
  exports["Picture"] = Picture;
  exports["drawPicture"] = drawPicture;
  exports["draw"] = $foreign.draw;
})(PS);
PS["Halogen.Canvas.Example.Main"].main();